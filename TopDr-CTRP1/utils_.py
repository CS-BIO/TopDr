...
def multiomics_data():
    RNAseq = np.genfromtxt("{}{}.csv".format(path, "CTRP1_RNAseq"), delimiter=',', skip_header=1, dtype=np.dtype(str))
    ...
    fingerprint = pd.read_csv("{}{}.csv".format(path, "CTRP1_fingerprint_881dim"),  skiprows=0)
    final_fingerprint = []
    ...
    lablefile = csv.reader(open("{}{}.csv".format(path, "CTRP1_response"), 'r'))
